...
public static class YoloPredictorAsyncExtensions
{
    ...
    /// <summary>
/// 异步版的预测器扩展方法集合。为同步 Predict 方法提供 Task 封装，适用于将推理放到后台线程运行的场景。
/// A collection of asynchronous predictor extension methods. Provides Task encapsulation for synchronous Predict methods, suitable for running inference on background threads.
/// </summary>
