...
html,body{margin:0;height:100%;background:#141414;color:#ececec;
  font:14px/1.6 -apple-system,BlinkMacSystemFont,"Microsoft YaHei",sans-serif}
header{padding:10px 14px;border-bottom:1px solid #2b2b2b;display:flex;
  justify-content:space-between;align-items:center}
h1{font-size:15px;font-weight:500;margin:0}
.hint{color:#7d7d7d;font-size:12px}
deep-chat{width:100%;height:calc(100% - 44px);display:block}
</style>
</head>
<body>
<header><h1>AI 检测助手</h1><span class="hint">查询检测记录 / 统计 / 相机参数</span></header>
<deep-chat
